        ...
        <footer className="relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    >
                        <span className="block">Ready to transform your <span className="text-purple-600 dark:text-purple-400">café with AI-powered growth</span>?</span>
                    </motion.h2>
                    <motion.p
                    ...
                    >
                        <span className="block">Join cafés already using Coffee Mustache to boost customer loyalty,</span>
                        <span className="block">increase order values, and grow their business with AI agents</span>
                    ...
                    >
                        <AnimatedGradientButton
                            ...
                            onClick={(e) => {
                                ...
                                const target = document.querySelector('#contact') || document.querySelector('#demo');
                                if (target) {
                ...
                <div className="mt-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-6 text-foreground/85 text-sm sm:text-base">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <a href="mailto:teja@coffeemustache.com" className="hover:underline">teja@coffeemustache.com</a>
                    </div>
                    {/* Website */}
                    <div className="flex items-center gap-2">
                        ...
                        <a href="https://coffeemustache.in" target="_blank" className="hover:underline">coffeemustache.in</a>
                    </div>
                </div>
                ...
                <div className="mt-6 w-full flex flex-col-reverse sm:flex-row items-center sm:items-center justify-between gap-3 sm:gap-4 text-foreground/70 text-sm">
                    ...
                    <div className="opacity-80 sm:text-right w-full sm:w-auto text-center sm:text-right">© 2025 Coffee Mustache. All rights reserved.</div>
                </div>
            </div>
        </footer>
    );
