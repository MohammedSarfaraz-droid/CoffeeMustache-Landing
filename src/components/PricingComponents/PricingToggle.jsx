                ...
                >
                    <div className="flex items-start justify-between">
                        <div className="text-left">
                            ...
                            <div className="text-xs sm:text-sm opacity-70 font-medium">{plan.period}</div>
                            <div className={`text-xs sm:text-sm ${plan.labelClass || 'opacity-60 font-medium'}`}>
                                {plan.label}
                            </div>
                        </div>
                        <div className={`w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 rounded-full border-2 flex items-center justify-center ${
                            selectedPlan === plan.id
