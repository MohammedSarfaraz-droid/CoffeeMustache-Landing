...
const Card = ({ card }) => {
  return (
    <div className="w-full">
      <div
        className="max-w-7xl mx-auto rounded-3xl p-8 sm:p-12 bg-black/20 backdrop-blur-md border border-white/10 relative"
        style={{
          background: `
  ...
  return (
    <div className="w-full relative">
      ...
      <div className="text-center py-16 px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-foreground dark:text-white leading-tight">
