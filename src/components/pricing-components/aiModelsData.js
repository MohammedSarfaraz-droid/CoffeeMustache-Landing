...
export const aiModels = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M16.4875 0.00012207V6.06012H18.75V14.6835H16.3042V20.0001L10.44 14.8385V19.9593H9.53083V14.8326L3.66 20.0001V14.6126H1.25V5.99012H3.65333V0.00012207L9.53083 5.41179V0.158455H10.4392V5.56679L16.4875 0.00012207Z"
          fill="white"
          fillOpacity="0.8"
        />
      </svg>
...
// Features data
export const existingPosFlaws = [
  "Built for restaurants & retail — not cafés",
  "High upfront or recurring costs (₹10,000+/year)",
  "Complex setups with unnecessary features",
  "No AI-driven insights or growth support",
  "Limited or outdated reporting capabilities",
  "Vendors focus on transactions, not your growth",
  "Loyalty programs are generic, not tailored for cafés",
  "Poor customer experience",
  "Upgrades and support often come with hidden charges",
  "Doesn’t actively help you increase repeat sales or revenue",
];

export const coffeeFeatures = [
...
export const plans = {
  existingPOS: {
    ...
    features: [
      ...
      "24/7 support on WhatsApp, call, or Zoom",
      "No disruption to current operations",
    ],
  },
  cmPOS: {
    title: "Coffee Mustache POS Upgrade",
    price: "₹0 cost for lifetime",
    description:
      "Upgrade to Coffee Mustache POS — full POS + AI agents that not only suggest but execute growth actions.",
    features: [
      "Full POS features with café-first workflows",
      "AI agents that execute actions (not just suggest)",
      "Customer app with personalized recommendations",
      "One-click campaigns & loyalty automation",
      "Owner’s 360° growth dashboard",
    ],
  },
};
